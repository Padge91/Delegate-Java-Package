...
public class Delegate {
	...
	public void add(Delegate d) throws DelegateException {
		...
		if (d.getSize() != 1) {
			throw new DelegateException("Delegate must be of size one.");
		}
		else {
			addToList(d.getObject(0), d.getMethod(0), d.getString(0));
		}
	}
	...
	private void addToList(Object o, Method m, String s) {
		objectList.add(o);
		methodList.add(m);
		stringList.add(s);
		size++;	
